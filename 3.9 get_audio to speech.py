...
def speak(tekst):
    tts = gTTS(text=tekst, lang="en-uk")
    filename = "voice.mp3"
    tts.save(filename)
...
save_dir = os.path.join("D:\Documents\Python\intents\Cornel save map", "save")
